...
- The maximum value in both plots is indicated by the line above the whiskers. These are identical. Try again.
- The third quartile in both plots is indicated by the top edge of the boxes. These are identical. Try again.
- The median value in both plots is indicated by the thick line within the box. These are identical. Try again.
- Correct! Box-and-whiskers plots do not show the mean values in a sample. Although these two plots have identical quartile distributions, medians, and ranges, the mean values are actually different (7.8 in the treatment and 7.5 in the control).
